...
def russian_nu():
    ...
    a=Button(root,justify = LEFT)#button_0
    photoa=PhotoImage(file="word-g.gif")
    a.config(image=photoa,width="70",height="70")
    a.place(x=60,y=70)

    b=Button(root,justify = LEFT)#button_1
    photob=PhotoImage(file="number-g.gif")
    b.config(image=photob,width="70",height="70")
    b.place(x=170,y=70)

    c=Button(root,justify = LEFT)#button_2
    photoc=PhotoImage(file="number-g.gif")
    c.config(image=photob,width="70",height="70")
    c.place(x=280,y=70)

    d=Button(root,justify = LEFT)#button_3
    photod=PhotoImage(file="word-g.gif")
    d.config(image=photod,width="70",height="70")
    d.place(x=60,y=170)

    e=Button(root,justify = LEFT)#button_4
    photoe=PhotoImage(file="number-g.gif")
    e.config(image=photoe,width="70",height="70")
    e.place(x=170,y=170)

    f=Button(root,justify = LEFT)#button_5
    photof=PhotoImage(file="number-g.gif")
    f.config(image=photof,width="70",height="70")
    f.place(x=280,y=170)

    g=Button(root,justify = LEFT)#button_6
    photog=PhotoImage(file="word-g.gif")
    g.config(image=photog,width="70",height="70")
    g.place(x=60,y=270)

    h=Button(root,justify = LEFT)#button_7
    photoh=PhotoImage(file="number-g.gif")
    h.config(image=photoh,width="70",height="70")
    h.place(x=170,y=270)

    i=Button(root,justify = LEFT)#button_8
    photoi=PhotoImage(file="number-g.gif")
